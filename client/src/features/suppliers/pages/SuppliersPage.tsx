...
const contracts: Contract[] = [
  ...
  { id: 'P-2024-0105', name: 'AI 기반 수요예측 플랫폼 연구용역', agency: '한국정보화진흥원', period: '2024.03 - 2024.09', amount: '₩420,000,000', progress: '15%', status: '진행중' },
    ...
    <section>
      ...
      <Card className="mb-10 p-8">
        <div className="grid items-center gap-8 xl:grid-cols-[1fr_220px_220px_220px]">
          ...
          <CompanyMetric label="Project Health" value="•94%" />
        </div>
      </Card>
